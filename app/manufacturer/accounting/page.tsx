...
export default function AccountingDashboard() {
  ...
  const fetchStats = async () => {
    ...
    const countRes = await fetchWithAuth(`${API_URL}/api/invoice/invoices/count/?company=${companyId}`);
    const countData = await countRes.json();

    // Fetch all invoices for the company
    const invoicesRes = await fetchWithAuth(`${API_URL}/api/invoice/invoices/?company=${companyId}`);
